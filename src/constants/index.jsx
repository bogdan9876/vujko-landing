...
export const faq = [
  {
    ...
    answer:
      "Плата ініціації Vujko підтримує два основних режими роботи: режим БПЛА (дрон) та стаціонарний режим міни, які можна налаштувати серверно. Пристрій підримує різні методи ініціації: інерційне спрацьовування, ударна детонація, програмне примусове від команди оператора.",
  },
  {
    id: "2",
    question: "Як підключитися до веб-налаштувань пристрою?",
    answer:
      "Для доступу до веб-налаштувань пристрою потрібно підключитися до Wi-Fi мережі <Vujko-...> або за адресою vujko.local (192.168.4.1) через браузер. Це дозволить налаштувати параметри часу, режиму роботи та конфігурувати акселерометр.",
  },
  {
    id: "5",
    question: "Як виглядає процес активації режиму FPV?",
    answer:
      "Плата ініціації Вуйко за замовчуванням знаходиться у режимі дрона. Протягом 120 сек від початку запуску пристрою доступна можливість зміни конфігурації веб-налаштуваннях. Налаштування часу самознищення доступні тільки в режимі ARM.",
  },
  {
    id: "6",
    question: "Як виглядає процес активації режиму міни?",
    answer:
      "Перевести пристрій в стаціонарний режим можна у веб-налаштуваннях. Після видалення запобіжної шпильки запускається таймер зворотного відліку, який дає оператору 120 секунд для встановлення СВП у фіксованеположення та виходу із зони впливу вибухівки. В активному стані: будь-який рух, нахил або зміна положення призведе до детонації. Починаючи з 121 секунди, запускається вторинний таймер зворотного відліку, який закінчується через 1200 секунд."
  },
  {
    id: "8",
    question: "Як дізнатися про помилки в роботі пристрою?",
    answer:
      "Пристрій має вбудовану систему індикації помилок, яка повідомляє про різні неполадки через миготіння світлодіода. Детальніша інформація є в ТТХ та інструкції до використання",
  },
  {
    id: "9",
    question: "Які рівні безпеки має плата ініціації?",
    answer:
      "Плата ініціації Vujko забезпечує 3 рівні безпеки: механічний, апаратний та програмний. Це забезпечує надійність при використанні як у бойових, так і в тренувальних умовах.",
  }
];
...
export const socials = [
  ...
  },
  {
    ...
    url: "mailto:vladislavvanyuk@gmail.com",
  },
  {
    id: "3",
    title: "Telegram",
